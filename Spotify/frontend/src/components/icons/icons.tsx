...
export const AddMusicIcon = ({ className }: Props) => {
  return (
    <svg
      data-encore-id="icon"
      role="img"
...
export const AddedMusicIcon = ({ className }: Props) => {
  return (
    <svg
      data-encore-id="icon"
      role="img"
...
export const ShuffleMusicIcon = ({ className }: Props) => {
  return (
    <svg
      data-encore-id="icon"
      role="img"
...
export const PreviousMusicIcon = ({ className }: Props) => {
  return (
    <svg
      data-encore-id="icon"
      role="img"
...
export const StartMusicIcon = ({ className }: Props) => {
  return (
    <svg
      data-encore-id="icon"
      role="img"
...
export const StopMusicIcon = ({ className }: Props) => {
  return (
    <svg
      data-encore-id="icon"
      role="img"
...
export const NextMusicIcon = ({ className }: Props) => {
  return (
    <svg
      data-encore-id="icon"
      role="img"
...
export const RepeatMusicIcon = ({ className }: Props) => {
  return (
    <svg
      data-encore-id="icon"
      role="img"
...
export const RepeatOneTimeMusicIcon = ({ className }: Props) => {
  return (
    <svg
      data-encore-id="icon"
      role="img"
...
export const PlayBackViewIcon = ({ className }: Props) => {
  return (
    <svg
      data-encore-id="icon"
      role="img"
...
export const LyricsIcon = ({ className }: Props) => {
  return (
    <svg
      data-encore-id="icon"
      role="img"
...
export const QueueIcon = ({ className }: Props) => {
  return (
    <svg
      data-encore-id="icon"
      role="img"
...
export const DevicesIcon = ({ className }: Props) => {
  return (
    <svg
      ...
      fill="currentColor"
    >
      <path d="M2 3.75C2 2.784 2.784 2 3.75 2h8.5c.966 0 1.75.784 1.75 1.75v6.5A1.75 1.75 0 0 1 12.25 12h-8.5A1.75 1.75 0 0 1 2 10.25zm1.75-.25a.25.25 0 0 0-.25.25v6.5c0 .138.112.25.25.25h8.5a.25.25 0 0 0 .25-.25v-6.5a.25.25 0 0 0-.25-.25zM.25 15.25A.75.75 0 0 1 1 14.5h14a.75.75 0 0 1 0 1.5H1a.75.75 0 0 1-.75-.75"></path>
    </svg>
  );
};
...
export const VolumeLowIcon = ({ className }: Props) => {
  return (
    <svg
      data-encore-id="icon"
      role="presentation"
...
export const VolumeMediumIcon = ({ className }: Props) => {
  return (
    <svg
      data-encore-id="icon"
      role="presentation"
...
export const VolumeHighIcon = ({ className }: Props) => {
  return (
    <svg
      data-encore-id="icon"
      role="presentation"
...
export const MiniReaderIcon = ({ className }: Props) => {
  return (
    <svg
      data-encore-id="icon"
      role="img"
...
export const ExitFullScreenIcon = ({ className }: Props) => {
  return (
    <svg
      width="16"
      height="16"
...
export const ConnectDeviceIcon = ({ className }: Props) => {
  return (
    <svg
      data-encore-id="icon"
      role="img"
...
export const ArrowDown = ({ className }: Props) => {
  return (
    <svg
      ...
      fill="currentColor"
    >
      <path d="M.47 4.97a.75.75 0 0 1 1.06 0L8 11.44l6.47-6.47a.75.75 0 1 1 1.06 1.06L8 13.56.47 6.03a.75.75 0 0 1 0-1.06"></path>
    </svg>
  );
};
...
export const ArrowUp = ({ className }: Props) => {
  return (
    <svg
      ...
      fill="currentColor"
    >
      <path d="M.47 11.03a.75.75 0 0 0 1.06 0L8 4.56l6.47 6.47a.75.75 0 1 0 1.06-1.06L8 2.44.47 9.97a.75.75 0 0 0 0 1.06"></path>
    </svg>
  );
};
