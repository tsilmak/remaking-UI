...
const PlayerBar = () => {
  ...
  const [shuffleState, setShuffleState] = useState<ToggleRepeatMusic>({
    on: false,
    off: true,
    onetime: false,
  });
  ...
  }, [handleVolumeMouseMove, isVolumeDragging]);
  ...
  }, [currentIndex, isDragging, shuffleState]);
  ...
  }, [isMusicPlaying, currentIndex, volume]);
        ...
        <div className="flex-1 text-center">
          <div className="flex space-x-4">
            ...
            <div className="flex flex-col justify-center items-start">
              ...
              <p className="text-[#999999] text-xs flex items-center gap-1 tracking-tight cursor-pointer hover:underline hover:text-[#ebebeb]">
                {music.hasVideoClipe && (
                  <>
